...
def mainlist(item):
    logger.info("[documentaristreamingdb] mainlist")
    itemlist = [Item(channel=__channel__,
                     title="[COLOR azure]Aggiornamenti[/COLOR]",
                     action="peliculas",
                     url=host + "/?searchtype=movie&post_type=movie&sl=lasts&s=",
                     thumbnail="https://raw.githubusercontent.com/unicorn-addon/unicorn-addon/master/images/channels_icons/documentari.png"),
...
def newest(categoria):
    logger.info("[documentaristreamingdb] newest" + categoria)
    itemlist = []
    item = Item()
    try:
...
def search(item, texto):
    logger.info("[documentaristreamingdb] " + item.url + " search " + texto)
...
def peliculas(item):
    logger.info("[documentaristreamingdb] peliculas")
    itemlist = []
...
def findvideos(item):
    logger.info("[documentaristreamingdb] findvideos")
