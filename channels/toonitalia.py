...
def mainlist(item):
    ...
    itemlist = [Item(channel=__channel__,
                ...
                # url=host,
                # thumbnail="https://raw.githubusercontent.com/unicorn-addon/unicorn-addon/master/images/channels_icons/anime_genre_P.png"),
                # Item(channel=__channel__,
                # title="[COLOR azure]Anime [COLOR orange]- Film Animation[/COLOR]",
                # action="lista_animation",
                # extra="movie",
                # url="%s/lista-film-animazione/" % host,
                # thumbnail="https://raw.githubusercontent.com/unicorn-addon/unicorn-addon/master/images/channels_icons/animated_movie_P.png"),
                Item(channel=__channel__,
